...
@interface ZTAdView : UIView<UIScrollViewDelegate>

@property(nonatomic,strong) UIScrollView   * adScrollView;
@property(nonatomic,strong) UIPageControl  * pageControl;
@property(nonatomic,retain) NSTimer        * adLoopTimer;
@property(nonatomic,  copy) NSString       * placeImageSource;// 占位图
...
- (void)adView:(ZTAdView *)adView didDeselectAdAtNum:(NSInteger)num;
